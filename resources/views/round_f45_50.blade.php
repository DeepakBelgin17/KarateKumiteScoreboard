...
<body>
 ...
 <div class="container-fluid bg ">
    ...
    <div class="row">
        ...
        <div class="col-4">
            @if ($d->isNotEmpty())
            <br><center> <input type="text" class="form-control ran1 mt-1 w-50 text-danger"  value="{{$d[0]->category}}" readonly ></center>
            @else
    ...
    @csrf
      ...
      <div class="row mb-3">
        <div class="col-1 ">
            ...
            <input type="text" class="form-control mt-3 w-75 " id="name" placeholder="" value="{{$dd->id}}" readonly>
        ...
        <div class="col-3">
          ...
          <input type="text" class="form-control mt-3 w-80" id="name" placeholder="" name="athlete_name" value="{{$dd->name}}" readonly>
